...
![Разделение ответственности](/images/soc.png 'Separation of concerns')
...
[React](https://reactjs.org/) стал одной из первых библиотек (гусары, молчать!) принёсшей компоненты в народ. Концепция JSX - HTML код совмещённый с JavaScript - была [не новой](https://en.wikipedia.org/wiki/ECMAScript_for_XML), но создателям React удалось донести её в понятной форме массе веб-разработчиков. Естественно, мир им не ограничивается, просто в рамках данной статьи так удобнее.
...
![JSS is Awesome]('/images/jss.png' 'JSS Logo')
...
Как я уже сказал, 2014-2016 года были щедры на идеи. Можно было даже на уровне транспилятора всё это решить. Встречайте, [babel-plugin-css-in-js](https://github.com/martinandert/babel-plugin-css-in-js). Распыляться не буду, смотрим. Вход:
