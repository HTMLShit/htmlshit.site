...
Авторы, [Саша Беспоясов](https://bespoyasov.ru/) и [Артём Самофалов](https://github.com/dex157), объясняют пять принципов, образующих SOLID, на понятных примерах, а в конце каждой секции имеется краткий опросник (флешбеки из школьных времён).
